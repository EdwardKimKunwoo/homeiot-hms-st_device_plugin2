...
function LoadLanguageSet(_localeCode_) {
    switch (_localeCode_) {
        case 'ko_KR':
            ...
            LanguageSet['DEVICE_DISCONNECTED_MESSAGE'] = '아파트 월패드의 디바이스 연결 상태를 확인해주세요. 디바이스가 계속 연결되지 않는다면 %s를 다시 추가해주세요.';
            ...
            LanguageSet['THERMOSTAT_BIXBY'] = '\"하이 빅스비, 온도조절장치 난방온도 24도로 설정해줘.\"';
            ...
            // Gas Valve
            LanguageSet['GASVALVE_NAME'] = "가스 밸브";
            LanguageSet['GASVALVE_WARN_MESSAGE_CLOSE_ONLY'] = '안전을 위해 원격으로는 밸브를 닫을 수만 있어요.<br>제어 후 가스 밸브가 닫혀 있는지 반드시 확인하세요.';
            LanguageSet['GASVALVE_WARN_MESSAGE_NO_CONTROL'] = '가스 밸브의 열림, 닫힘에 대한 현재 상태 정보 확인이 가능합니다.';
            LanguageSet['GASVALVE_CONTROL_DENY'] = '가스 밸브의 열림/닫힘 상태의 정보의 확인만 가능해요.';
            LanguageSet['GASVALVE_OPERATION_FAIL'] = '가스 밸브가 닫히지 않았어요.';
            LanguageSet['GASVALVE_OPEN'] = '열림';
            LanguageSet['GASVALVE_CLOSE'] = '닫힘';
            LanguageSet['GASVALVE_BIXBY'] = '\"하이 빅스비, 가스 밸브 잠궈줘.\"';
            LanguageSet['GASVALVE_BIXBY_NO_CONTROL'] = '\"하이 빅스비, 가스 밸브 상태 확인해줘.\"';
            ...
            LanguageSet['ELEVATOR_LABLE'] = '엘리베이터';
            LanguageSet['ELEVATOR_INFORMATION'] = "엘리베이터 호출 시 거주 층에서 아래 층으로 향하는 엘리베이터를 예약하여 사용하실 수 있습니다.<br>탑승 후에 엘리베이터 안에서 이동 층을 선택할 수 있습니다.";
            LanguageSet['ELEVATOR_BIXBY'] = '\"하이 빅스비, 엘리베이터 호출해줘.\"';
            LanguageSet['___PO_CODE_ELEVATOR_BUTTON'] = '엘리베이터 버튼';
            LanguageSet['ELEVATOR_CONNECTION_ERROR'] = '지금은 %s를 호출 할 수 없어요.<br>잠시 후 다시 시도해주세요.';
            // Vent
            ...
            LanguageSet['SMARTPLUG_AUTOSHOT_INFORMATION'] = '설정 값보다 작은 값이 일정 시간 동안 지속되면 자동으로 전원이 꺼져요.';
            LanguageSet['SET_THRESHOLD'] = '대기전력 허용 한계값';
            LanguageSet['SMARTPLUG_BIXBY'] = '\"하이 빅스비, 전원플러그 켜줘.\"';
            // FIXME: VideoIntercom
            ...
            //activity history
            LanguageSet['replace_keyword_dimmer'] = "조광기";
        ...
        default:
            ...
            LanguageSet['DEVICE_DISCONNECTED_MESSAGE'] = 'Check to see if the apartment\'s wall pad device is connected. If the device keeps failing to connect, add %s again.';
            ...
            LanguageSet['OPERATION_FAIL_TITLE'] = 'Controlling failed';
            ...
            LanguageSet['THERMOSTAT_BIXBY'] = '\"Hi Bixby, Set the thermostat heating to 24 degrees.\"';
            ...
            LanguageSet['GASVALVE_WARN_MESSAGE_CLOSE_ONLY'] = 'For your safety, remote controlling of the gas valve is only available for closing, not opening.<br>After controlling the valve, always make sure the valve is closed.';
            ...
            LanguageSet['ELEVATOR_LABLE'] = 'elevator';
            ...
            LanguageSet['ELEVATOR_CONNECTION_ERROR'] = 'There is a problem connecting to %s.<br>Try again later.';
            // Vent
