 ...
 * Configure Value
 *******************************************************************************/
var HNDevicePluginVersion = "2.9.15"; // plugin : 2.9.15, ST app : 1.7.86.21, Date : May 27 2022
...
MainController.prototype = {
    ...
    refresh: async function() {
        ...
        .then((v) => {
            ...
            this.pluginLoadState = PLUGIN_LOAD_STATE_LOADED;
            HNView.showNetworkErrDlg(ST_API_DOES_NOT_WORK, false, {delay: 500});
            LoggerW(e);
        });
    },
...
MainView.prototype = {
    ...
    showNetworkErrDlg: function(type, exit, opt) {
