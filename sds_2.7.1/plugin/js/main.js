...
var HNDevicePluginVersion = "2.7.1"; // plugin : 2.7.1, ST app : 1.7.55, Date : Oct 28 2020
...
MainView.prototype = {
    ...
    showNotificationCard: function(deviceName, state) {
        ...
        const candidates = {
            ...
            DISCONNECTED: {
                title: C_('DEVICE_DISCONNECTED_TITLE'), message: C_('DEVICE_DISCONNECTED_MESSAGE', 'HomeNet')
            }
        };
    ...
    showInformationPage: function() {
        ...
        if (window.provider) {
            if(window.provider.name) {
                bundle['providerName'] = window.provider.name;
            }
