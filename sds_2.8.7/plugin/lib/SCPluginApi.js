...
window.__onNMRepresentCallback = function (json) {
    var result = JSON.parse(json);
    var f = window.scplugin._scPluginNative.getCallback(result);
    if (f) {
        setTimeout(function() {
            try {if (typeof result.representation === "string") { result.representation = JSON.parse(result.representation); }} catch(e) {}
            try {
...
window.__onNMMonitoringStateCallback = function (json) {
    var result = JSON.parse(json);
    var f = window.scplugin._scPluginNative.getCallback(result);
    if (f) {
        setTimeout(function() {
...
window.__onNMSystemSetStatusBarThemeCallback = function (json) {
    var result = JSON.parse(json);
    var f = window.scplugin._scPluginNative.getCallback(result);
    if (f) {
        setTimeout(function() {
...
window.__onNMProdGetAddressFromPositionCallback = function (json) {
    ...
    if (f) {
        setTimeout(function() {
            try {
                f(result.address, result.fullContext);
            } catch (e) {
                console.error(e);
            }
        }, 0);
...
(function(window, document, undefined) {
    ...
    manager.prototype = {
		...
		/**
         * @api window.scplugin.manager.getInstalledAppId(appId,onInstalledAppIdCallback,onErrorCallback) void getInstalledAppId()
         ...
         *     console.log("error name: " + error.name + " message: " + error.message);
         * }
         * scplugin.manager.getInstalledAppId(appId, onInstalledAppIdCallback, onErrorCallback);
         */
        getInstalledAppId: function(appId, onsuccess, onerror) {
         ...
         * @apiParam {Function} onAddressFromPositionCallback Receives state of Launch Darkly Configuration.
         * @apiParam {Function} onErrorCallback Receives the error object when an error occurs.
         *
         * @apiError (Error) {APIError} NotSupportedError if this feature is not supported.
         * @apiError (Error) {APIError} SecurityError if the plugin does not have the permission to call this method.
         ...
         *
         * @apiExample {js} Example usage:
         * function onAddressFromPositionCallback(address, fullContext) {
         *     console.log("Address : " + address);
         *     console.log("Full Context : " + JSON.stringify(fullContext));
         * }
         *
         * function onErrorCallback(error) {
         *     console.log("error name: " + error.name + " message: " + error.message);
    ...
    */
    ...
    SmartKit.prototype = {
         ...
         *
         * @apiExample {js} Example usage:
         * function onSTDeviceHealthChangeCallback(response) {
         *     console.log("getDeviceHealthData : " + JSON.stringify(response));
         * }
         *
         * function onErrorCallback(error) {
         ...
         *
         * @apiExample {js} Example usage:
         * function onSTDeviceLifecycleChangeListener(response) {
         *     console.log("onSTDeviceLifecycleChangeListener : " + JSON.stringify(response));
         * }
         *
         * function onErrorCallback(error) {
         *     console.log("error name: " + error.name + " message: " + error.message);
         ...
         *
         * @apiExample {js} Example usage:
         * function onSTInstalledAppLifecycleChangeListener(response) {
         *     console.log("onSTInstalledAppLifecycleChangeListener : " + JSON.stringify(response));
         * }
         *
         * function onErrorCallback(error) {
         *     console.log("error name: " + error.name + " message: " + error.message);
        ...
        /**
         * @api window.scplugin.smartkit.getTrackersMetadataMaps(clientIds,onSTTrackersMetadataMapsCallback,onErrorCallback) void getTrackersMetadataMaps()
         ...
         * @apiPrivate
         *
         * @apiParam {[String]} clientIds Array of Client ID. (Map Client Ids)
         ...
         * }
         *
         * window.scplugin.smartkit.getTrackersMetadataMaps(deviceIds, onSTTrackersMetadataMapsCallback, onErrorCallback);
         *
         */
        getTrackersMetadataMaps: function(clientIds, onsuccess, onerror) {
    ...
    Service.prototype = {
        ...
        /**
         * @api Service.createShortcut(onCreateShortcutCallback,onErrorCallback) void createShortcut()
    ...
    var OCFDevice = function(args) {
        Object.defineProperties(this, {
            ...
            metaData: {
                value: convertStringToObject(args.metaData),
                writable: false,
                enumerable: true
            },
            extraData: {
    ...
    OCFDevice.prototype = {
        ...
        getActivityHistory: function(onsuccess, onerror, requestBody) {
            var cmd = "scpluginProdGetDeviceActivityHistory";
            var args = {};
        ...
        getDeviceStatistics: function(requestBody, onsuccess, onerror) {
            var cmd = "scpluginProdGetDeviceStatistics";
            var args = {};
    ...
    BLEDevice.prototype = {
        ...
        /**
         * @api BLEDevice.unsetNotificationListener() void unsetNotificationListener()
    ...
    */
    ...
    systemTheme.prototype = {
       ...
       isInversionModeEnabled: function(onsuccess, onerror) {
        ...
        /**
         * @api SystemTheme.setStatusBarTheme() void setStatusBarTheme()
         * @apiName setStatusBarTheme()
         * @apiGroup SystemTheme
         * @apiDescription Change the theme of the status bar. This changes char and icon color
         * @apiVersion 1.3.5
         * @apiPermission public
         * @apiProfile common
         *
         * @apiParam {String} theme Theme information
         * @apiParam {Function} onSetStatusBarThemeCallback Receives whether the theme has been changed.
         * @apiParam {Function} onErrorCallback Receives the error object when an error occurs.
         *
         * @apiError (Error) {APIError} NotSupportedError if this feature is not supported.
         * @apiError (Error) {APIError} UnknownError if any other error occurs.
         *
         * @apiExample {js} Example usage:
         * function onSetStatusBarThemeCallback(state) {
         ...
         *   systemTheme.setStatusBarTheme(theme, onSetStatusBarThemeCallback, onErrorCallback);
         * }
         *
         */
        setStatusBarTheme: function(theme, onsuccess, onerror) {
            var cmd = "scpluginSetStatusBarTheme";
            var args = {};
            args.callbackName = "__onNMSystemSetStatusBarThemeCallback"
            args.cmd = cmd;
            args.theme = theme
            try {
                window.scplugin._scPluginNative.call(cmd, args, onsuccess, onerror);
 ...
 */
 ...
 /**
  * @api onSTDeviceHealthChangeCallback(response) void onSTDeviceHealthChangeCallback()
  ...
  * @apiExample {js} Callback Function - Example usage:
  *
  * Response data, please refere linke below,
  ...
  *
  * function onSTDeviceHealthChangeCallback(response) {
  *     console.log("getSTDeviceHealthDataChangeCallback : " + JSON.stringify(response));
  * }
  *
  */

  /**
   * @api onSTDeviceLifecycleChangeListener(response) void onSTDeviceLifecycleChangeListener()
   ...
   */
   ...
   /**
    * @api onSTInstalledAppLifecycleChangeListener(response) void onSTInstalledAppLifecycleChangeListener()
 ...
 * @apiExample {js} Callback Function - Example usage:
 * Please refer this Link :
 * https://smartthings.atlassian.net/wiki/spaces/FP/pages/939398267/API+Spec+WIP#GET-/metadata/maps--??CAPI-(MMVP)
 *
 * function onSTTrackersMetadataMapsCallback(response) {
...
/**
 * @api onSetStatusBarThemeCallback(state) void onSetStatusBarThemeCallback()
 * @apiName onSetStatusBarThemeCallback
 * @apiGroup SystemTheme
 ...
 * // on iOS for that position
 * {
 *   "street": Seocho-daero 75-gil,
 *   "subLocality": "",
 *   "city": "Seoul",
 ...
 * }
 *
 * // on Android for that position
 * {
 *   "addressLines": ["1317-26 Seocho 4(sa)-dong, Seocho-gu, Seoul, South Korea"],
 *   "feature": "1317-26",
 *   "admin"": "Seoul",
 *   "sub-admin": "null",
 *   "locality"": "null",
 *   "thoroughfare": "Seocho 4(sa)-dong",
 *   "postalCode"": "137-074",
 *   "countryCode": "KR",
 *   "countryName": "South Korea",
 *   "hasLatitude": "true",
 *   "latitude": "37.497965199999996",
 *   "hasLongitude": "true",
 *   "longitude": "127.02610659999999",
 *   "phone": "null",
 *   "url": "null",
 *   "extras": "null"
 * }
